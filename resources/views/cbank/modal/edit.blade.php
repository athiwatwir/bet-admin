        ...
        <div class="modal-content">
            ...
            @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="edit_bank_group" class="col-md-4 col-form-label text-md-right">{{ __('กลุ่มบัญชีธนาคาร') }} <span class="text-danger">*</span></label>

                        <div class="col-md-6">
                            <select id="edit_bank_group" class="form-control" name="edit_bank_group" required autocomplete="edit_bank_group">
