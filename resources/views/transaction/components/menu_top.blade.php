<span class="d-block text-muted text-truncate font-weight-medium pt-1">
    ...
    <a href="@if($type == 'DEPOSIT') #! @else {{ route('transaction-deposit') }} @endif" class="btn btn-sm btn-outline-secondary btn-secondary-hover @if($type == 'DEPOSIT') btn-primary  btn-hover-none text-white @else btn-soft @endif mb-1 mr-3"><x-notification-transaction-pending position="menu-deposit" />คำร้องการฝากเงิน</a>
    ...
    <a href="@if($type == 'WITHDRAW') #! @else {{ route('transaction-withdraw') }} @endif" class="btn btn-sm btn-outline-secondary btn-secondary-hover @if($type == 'WITHDRAW') btn-primary  btn-hover-none text-white @else btn-soft @endif mb-1 mr-3"><x-notification-transaction-pending position="menu-withdraw" />การถอนเงิน</a>
