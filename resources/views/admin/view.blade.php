...
@section('title', 'รายละเอียดผู้ดูแลระบบ')
    ...
    <div class="col-12 col-lg-12 col-xl-12">
        ...
        <div class="portlet">
            ...
            <div class="portlet-header border-bottom">
                ...
                <div class="float-end">
                    <a href="/admins" class="btn btn-sm btn-primary btn-pill px-2 py-1 fs--15 mt--n3">
                        < ย้อนกลับ
                    </a>
                </div>

                <span class="d-block text-muted text-truncate font-weight-medium pt-1">
                    รายละเอียดผู้ดูแลระบบ <strong class="text-dark">{{ $username }}</strong>
                </span>
            </div>
            <!-- /portlet : header -->
