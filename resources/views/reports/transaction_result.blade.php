    ...
    <div class="col-12 col-xl-6">
        ...
        <nav aria-label="pagination">
            <ul class="pagination pagination-pill justify-content-end justify-content-center justify-content-md-end">
                ...
                <li class="{{ $results->onFirstPage() ? 'page-item btn-pill disabled' : 'page-item btn-pill' }}">
                    <a class="page-link" href="{{ $results->previousPageUrl() }}" tabindex="-1" aria-disabled="true">ก่อนหน้า</a>
                </li>
                ...
                <li class="{{ $results->currentPage() == $results->lastPage() ? 'page-item disabled' : 'page-item' }}">
                    <a class="page-link" href="{{ $results->nextPageUrl() }}">ถัดไป</a>
                </li>

            </ul>

            <div class="justify-content-end justify-content-center justify-content-md-end text-right">
                <small>หน้า : {{ $results->currentPage() }} / {{ $results->lastPage() }}</small>
            </div>
        </nav>
        <!-- pagination -->
